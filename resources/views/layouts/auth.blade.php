...
<html lang="en">
  <head>
    ...
    <meta name="description" content="{{ URL::asset('assets/img/shopping_cart_accept.ico') }}">
    ...
    <link href="{{ URL::asset('assets/bower_components/bootstrap/dist/css/navbar-fixed-top.css') }}" rel="stylesheet">
